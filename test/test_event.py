...
'''
    ...
    with contextlib.redirect_stdout(stdout):
        markdown_to_pofile(md_content, debug=True)
...
md2po[DEBUG]::<date>::enter_span:: A - {'href': [(<TextType.NORMAL: 0>, 'https://foo.bar')], 'title': None}
md2po[DEBUG]::<date>::text:: referenced-link
md2po[DEBUG]::<date>::leave_span:: A - {'href': [(<TextType.NORMAL: 0>, 'https://foo.bar')], 'title': None}
md2po[DEBUG]::<date>::text:: .
md2po[DEBUG]::<date>::leave_block:: P
md2po[DEBUG]::<date>::msgid:: msgid='Content with `span` and [referenced-link][link].' - msgctxt='foo and bar'
md2po[DEBUG]::<date>::enter_block:: HTML
...
md2po[DEBUG]::<date>::link_reference:: target='link' - href='https://foo.bar'
md2po[DEBUG]::<date>::msgid:: msgid='[link]: https://foo.bar' - msgstr='[link]: https://foo.bar' - flags='['fuzzy']'
'''
